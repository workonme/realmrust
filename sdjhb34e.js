...
cssScript.src = 'https://cdn.jsdelivr.net/gh/workonme/realmrust@main/css2.js?v=' + Date.now()
...
swiperScript.onload = () => {
  ...
  script.src = 'https://cdn.jsdelivr.net/gh/workonme/realmrust@main/js2.js?v=' + Date.now()
  script.async = true
  script.onload = () => {}
